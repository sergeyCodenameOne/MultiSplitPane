...
/**
 * Container that splits its available space into three parts, two for the
 * component given, and one fo the divider between them. the Split can have
 * horizontal orientation or vertical orientation.
 */
public class Split extends Container {
    ...
    /**
     * Creates a new Split Container that splits itself into two parts,
     * one for each component given.
     *
     * @param leftTop left/top component of the split.
     * @param rightBottom right/bottom component of the split.
     * @param orientation The orientation. One of {@link #HORIZONTAL_SPLIT} or
     * {@link #VERTICAL_SPLIT}.
     *
     * @return the newly created container.
     */
    public static Split split(Component leftTop, Component rightBottom, int orientation) {
        Split split = new Split(leftTop, rightBottom, orientation);
        return split;
    }

    /**
     * split the container into two parts, one is the old root and other is the
     * new Component
     *
     * @param cmp the new component for the split.
     * @param orientation the orientation of the new split. One of
     * {@link #HORIZONTAL_SPLIT} or {@link #VERTICAL_SPLIT}.
     * @param isTopOrLeft decides if the new component will be on the top/left
     * side of the division or the bottom/right side.
     * @return this for call chaining.
     */
    public Split split(Component cmp, int orientation, boolean isTopOrLeft) {
        return isTopOrLeft ? new Split(cmp, this, orientation)
                : new Split(this, cmp, orientation);
    }
    ...
    /**
     * return the orientation of the Split, One of {@link #HORIZONTAL_SPLIT} or
     * {@link #VERTICAL_SPLIT}.
     *
     * @return
     */
    ...
    /**
     * Set whether to show the expand button on the divider. Default is
     * {@literal true}.
     *
     * @param show {@literal true} to show the expand button. {@literal false}
     * to hide him.
     * @return Self for chaining.
     */
    ...
    /**
     * Set whether to show/hide the collapse button on the divider. Default is
     * {@literal true}.
     *
     * @param show {@literal true} to show the collapse button. {@literal false}
     * to hide him.
     * @return Self for chaining.
     */
    ...
    /**
     * Set whether to show/hide the drag label on the divider. Default is
     * {@literal true}.
     *
     * @param show {@literal true} to show the collapse button. {@literal false}
     * to hide him.
    ...
    /**
     * class that responsible for arranging the Components inside the Split
     * container.
     */
    ...
    /**
     * The divider class used by the Split Container to separate between two
     * components.
     */
    private static class Divider extends Container {
        ...
        /**
         * Return the orientation of the divider. One of
         * {@link #HORIZONTAL_SPLIT} or {@link #VERTICAL_SPLIT}.
         *
         * @return
         */
         ...
         * {@literal true}.
         *
         * @param show {@literal true} to show the expand button.
         * {@literal false} to hide him.
         */
        ...
        /**
         * Set whether to show the collapse button on the divider. Default is
         * {@literal true}.
         *
         * @param show {@literal true} to show the expand button.
         * {@literal false} to hide him.
        ...
        /**
         * Set whether to show the drag label on the divider. Default is
         * {@literal true}.
         *
         * @param show {@literal true} to show the expand button.
         * {@literal false} to hide him.
         ...
         *
         * @param show {@literal true} to show the divider. {@literal false} to
         * hide him.
         */
        ...
        private Border createBorder() {
            return (orientation == VERTICAL_SPLIT) ? Border.createCompoundBorder(Border.createBevelRaised(),
        ...
        private void updateParentRatio(final int x, final int y) {
            ...
            if (orientation == VERTICAL_SPLIT) {
                ...
                if (newRatio > parent.maxRatio) {
                    ...
                    parent.setRatio(Math.max(newRatio, ((Split) getParent()).getMinRatio()));
                }
            } else {
         ...
         *
         * @param orientation One of {@link #HORIZONTAL_SPLIT} or
         * {@link #VERTICAL_SPLIT}.
         * @return
         */
